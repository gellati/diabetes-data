...
namespace tablet {
  ...
  public:
    ...
    /* Floating point value of ith field. */
  ...
  public:
    ...
    /* Return the jth field of the row with the first argument as the first
       field. If none found, an empty string is returned. */
